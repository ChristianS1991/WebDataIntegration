...
public class MatchWbCountriesToWcpCities {
...
public static void main(String[] args) throws Exception{
        ...
        engine.writeCorrespondences(correspondences, new File("usecase/geography/output/wb_countries_wcp_cities_correspondences.csv"));
